 ...
 * 2017-04-12T10:32:32.825+08:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "ProviderService", 
                  wsdlLocation = "http://132.228.26.113/wxweboa/application/abzgpd.nsf/appback?wsdl",
...
public class ProviderService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://132.228.26.113/wxweboa/application/abzgpd.nsf/appback?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProviderService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://132.228.26.113/wxweboa/application/abzgpd.nsf/appback?wsdl");
        }
        WSDL_LOCATION = url;
    }
